...
export default function TunerPage() {
  ...
  const playReferenceTone = useCallback(() => {
    ...
    oscillator.frequency.setValueAtTime(target.hz, now);
    ...
    <section className="tuner-grid">
      ...
      <main className="tuner-core">
        ...
        <div className="tuner-actions">
          ...
          <button className="reference-tone-button" onClick={playReferenceTone}><Volume2 /><span>Escuchar {target.note}{target.octave}</span></button>
        </div>

  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-4 py-2.5 border-b border-[#E5E7EB]">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="text-[#6B7280] hover:text-[#1F2937] p-1 text-xs font-mono"
            title="Imprimir"
          >
            🖨️
          </button>
      ...
      <div className="overflow-x-auto p-4">
        <pre
          className="font-mono text-sm text-[#1F2937] whitespace-pre-wrap sm:whitespace-pre leading-relaxed"
        >
          {song.tablature}
        </pre>
        <div className="mt-4 text-[#9CA3AF] text-xs font-mono">{SITE_URL}</div>
      </div>
    </div>
  );
}

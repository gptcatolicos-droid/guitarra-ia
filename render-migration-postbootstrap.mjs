...
// The bulk-practice route depends on the server files generated by the main
// bootstrap, so install it only after those files exist.
await import('./render-practice-bulk-import.mjs');
